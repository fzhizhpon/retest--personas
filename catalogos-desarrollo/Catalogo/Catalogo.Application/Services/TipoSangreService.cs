...
namespace Catalogo.Application.Services
{
    ...
    {
        private readonly ITipoSangreRepository _repository;
        private readonly IMensajeRespuestaRepository _mensajeRepository;

        public TipoSangreService(ITipoSangreRepository repository, IMensajeRespuestaRepository mensajeRepository)
        {
            _repository = repository;
            _mensajeRepository = mensajeRepository;
        }

        public async Task<Respuesta> ObtenerTiposSangre()
        {
            ERespuesta codigoRespuesta = ERespuesta.OK;
            int codigoEvento = 0;

            (int codigo, IEnumerable<ComboDto> tiposSangre) = await _repository.SelectTipoSangre();
