...
namespace Catalogo.Application.Services
{
    ...
    {
        private readonly ITipoIdentificacionRepository _repository;
        ...
        public async Task<Respuesta> ObtenerTiposIdentificaciones()
        {
            ERespuesta codigoRespuesta = ERespuesta.OK;
            int codigoEvento = 0;

            (int codigo, IEnumerable<ComboDto> tiposIdentificaciones) = await _repository.SelectTiposIdentificaciones();
            ...
            return new Respuesta()
            {
                ...
                resultado = tiposIdentificaciones,
