...
namespace Catalogo.Application.Services
{
    public class CiudadService : ICiudadService
    {
        ...
        public async Task<Respuesta> ObtenerCiudadesPorProvincia(ObtenerCiudadProvincia dto)
        {
            ERespuesta codigoRespuesta = ERespuesta.OK;
            int codigoEvento = 0;

            (int codigo, IEnumerable<ComboDto> ciudades) = await _repository.SelectCiudadesPorProvincia(dto);
