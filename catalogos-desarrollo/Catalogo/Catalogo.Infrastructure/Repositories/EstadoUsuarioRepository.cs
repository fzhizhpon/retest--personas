...
namespace Catalogo.Infrastructure.Repositories
{
    public class EstadoUsuarioRepository : IEstadoUsuarioRepository
    {
        ...
        public EstadoUsuarioRepository(IConexion<OracleConnection> conexion, ILogger<EstadoUsuarioRepository> logger,
        ...
        public async Task<(int, IEnumerable<ComboDto>)> SelectEstadoUsuario()
        {
            try
            {
                string keyRedis = "EstadoUsuario"; //LLave
                ...
                if (paises is null)
                {
                    using (var connection = _conexion.ObtenerConexion())
                    {
                        try
                        {
                            ...
                            string query = Queries.EstadoUsuariosQuery.ObtenerEstadoUsuarios(_esquema);
                        ...
                        {
                            _logger.LogError($"ERROR: Error en el metodo SelectEstadoUsuarios, {ex}");
