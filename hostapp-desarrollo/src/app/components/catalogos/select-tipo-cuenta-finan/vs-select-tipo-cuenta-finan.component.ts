...
@Component({
	selector: 'vs-select-tipo-cuenta-finan',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoCuentaFinanComponent)
	}]
})
export class VsSelectTipoCuentaFinanComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('tipos-cuentas-financieras')
