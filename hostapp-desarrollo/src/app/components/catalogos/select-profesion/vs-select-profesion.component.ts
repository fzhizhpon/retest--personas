...
@Component({
	selector: 'vs-select-profesion',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectProfesionComponent)
	}]
})
export class VsSelectProfesionComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('profesiones')
