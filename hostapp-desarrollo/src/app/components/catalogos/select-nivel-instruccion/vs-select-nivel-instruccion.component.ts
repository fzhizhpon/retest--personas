...
@Component({
	selector: 'vs-select-nivel-instruccion',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectNivelInstruccionComponent)
	}]
})
export class VsSelectNivelInstruccionComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('niveles-instruccion')
