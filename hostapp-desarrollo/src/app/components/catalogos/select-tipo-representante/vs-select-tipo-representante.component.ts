...
@Component({
	selector: 'vs-select-tipo-representante',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoRepresentanteComponent)
	}]
})
export class VsSelectTipoRepresentanteComponent extends CatComun<number> implements AfterViewInit {
