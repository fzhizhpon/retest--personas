...
@Component({
	selector: 'vs-select-tipo-residencia',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoResidenciaComponent)
	}]
})
export class VsSelectTipoResidenciaComponent extends CatComun<number> implements AfterViewInit {
