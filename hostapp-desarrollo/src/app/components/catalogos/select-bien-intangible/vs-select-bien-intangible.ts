...
@Component({
	selector: 'vs-select-bien-intangible',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectBienIntangibleComponent)
	}]
})
export class VsSelectBienIntangibleComponent extends CatComun<number> implements AfterViewInit {
