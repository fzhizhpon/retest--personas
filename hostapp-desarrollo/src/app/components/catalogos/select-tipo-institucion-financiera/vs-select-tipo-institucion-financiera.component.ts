...
@Component({
	selector: 'vs-select-tipo-institucion-financiera',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoInstitucionFinancieraComponent)
	}]
})
export class VsSelectTipoInstitucionFinancieraComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('tiposinstitucionesfinancieras')
