...
@Component({
	selector: 'vs-select-tipo-contribuyente',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoContribuyenteComponent)
	}]
})
export class VsSelectTipoContribuyenteComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('TiposContribuyentes')
