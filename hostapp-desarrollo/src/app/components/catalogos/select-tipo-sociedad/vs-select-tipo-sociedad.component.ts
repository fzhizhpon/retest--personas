...
@Component({
	selector: 'vs-select-tipo-sociedad',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoSociedadComponent)
	}]
})
export class VsSelectTipoSociedadComponent extends CatComun<number> implements AfterViewInit {
