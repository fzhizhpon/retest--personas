...
@Component({
	selector: 'vs-select-tipo-discapacidad',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectTipoDiscapacidadComponent)
	}]
})
export class VsSelectTipoDiscapacidadComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('tipos-discapacidades')
