...
@Component({
	selector: 'vs-select-sexo',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectSexoComponent)
	}]
})
export class VsSelectSexoComponent extends CatComun<number> implements AfterViewInit {
