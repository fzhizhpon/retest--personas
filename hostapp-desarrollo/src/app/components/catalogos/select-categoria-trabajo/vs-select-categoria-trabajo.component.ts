...
@Component({
	selector: 'vs-select-categoria-trabajo',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectCategoriaTrabajoComponent)
	}]
})
export class VsSelectCategoriaTrabajoComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('tipos-trabajos')
