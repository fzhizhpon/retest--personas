...
@Component({
	selector: 'vs-select-operadora-movil',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectOperadoraMovilComponent)
	}]
})
export class VsSelectOperadoraMovilComponent extends CatComun<number> implements AfterViewInit {
