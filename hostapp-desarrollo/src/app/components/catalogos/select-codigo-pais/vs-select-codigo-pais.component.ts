...
@Component({
	selector: 'vs-select-codigo-pais',
	templateUrl: '../base/catalogo-base.html',
	styleUrls: ['../base/catalogo-base.scss'],
	providers: [{
		provide: NG_VALUE_ACCESSOR,
		multi: true,
		useExisting: forwardRef(() => VsSelectCodigoPaisComponent)
	}]
})
export class VsSelectCodigoPaisComponent extends CatComun<number> implements AfterViewInit {
	...
	cargarDatos() {
		...
		this._catalogoService.obtenerPorGet<number>('paises-marcado-moviles')
